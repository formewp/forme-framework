...
HTML
    ...
    if (defined('DB_FILE')) {
        ...
        define('FQDB', FQDBDIR . 'testing.sqlite3');
    }
    ...
    class PDOSQLiteUDFS
    {
         ...
         *
         * @param string $text
         * @param int    $pos  representing the start point
         * @param int    $len  representing the length of the substring(optional)
         *
         * @return string
         */
    ...
    class PDOEngine extends PDO
    {
        ...
        private function process_results($engine)
        {
            ...
            } elseif ($this->query_type === 'showindex') {
