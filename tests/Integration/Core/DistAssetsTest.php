...
const THEME_DIR  = '/public/wp-content/themes/twentytwentythree';
const ASSETS_DIR = '/assets/dist';
const DUMMY_FILE = 'dummy.txt';

beforeEach(function () {
    $this->rootDir = dirname(__FILE__, 4) . '/wp-test' . THEME_DIR;
...
test('uri() returns the uri of the file', function () {
    expect(Assets::uri(DUMMY_FILE))->toBe('../public/wp-content/themes/twentytwentythree/assets/dist/dummy.txt');
});
